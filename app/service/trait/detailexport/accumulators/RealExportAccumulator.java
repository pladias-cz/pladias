...
public class RealExportAccumulator extends NumericBaseExportAccumulator {
    public RealExportAccumulator(Trait trait, UserOptions userOptions,
    ...
    public void populateRecordFields(Model model) {
        if (!(model instanceof RealDatatype dao))
            return;
    ...
    private void updateCollectedValues(RealDatatype dao) {
