...
public class RealMultiExportAccumulator extends NumericBaseExportAccumulator {
    public RealMultiExportAccumulator(Trait trait, UserOptions userOptions,
    ...
    public void populateRecordFields(Model model) {
        if (!(model instanceof RealMultiDatatype dao))
            return;
    ...
    private void updateCollectedValues(RealMultiDatatype dao) {
