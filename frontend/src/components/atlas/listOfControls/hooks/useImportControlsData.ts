...
export interface UseImportControlsDataOptions {
    onSuccess?: (data: ImportControlRecord[], totalCount: number, filteredCount: number) => void;
}

export function useImportControlsData(options: UseImportControlsDataOptions = {}) {
    ...
    const fetchControls = useCallback(async ({
        ...
        const response = await axios.get("/api/react/importResult/validated", {
            params: {
                page: String(page),
